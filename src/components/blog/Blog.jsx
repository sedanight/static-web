        ...
        <div className="blog__container container grid">
          <div className="blog__item card card-two">
            ...
            <p className="blog__description">
              ...
              consequatur illum maxime dicta veniam error nemo pariatur fugit
              ex! Architecto quibusdam culpa a dolor distinctio quam iusto alias
              in aut.
            </p>
          ...
          <div className="blog__item card card-two">
            <span className="blog__date text-cs">NOVEMBER 20, 2022</span>
